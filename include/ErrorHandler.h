...
{
public:
	MyLangError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr);
...
//typedef shared_ptr<MyLangError> Err;

//Err makeError(string msgIn, ErrorPriority priorityIn, Token tokenIn=nullptr) {return Err(new MyLangError(msgIn, priorityIn, tokenIn));}
